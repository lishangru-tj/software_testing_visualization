  ...
  <div class="system-test">
    ...
    <div class="main-table">
      <el-table :data="tableData" :height="tableHeight" style="width: 100%" v-loading="loading"
        ...
        <el-table-column prop="S" label="实际状态" width="100" align="center"></el-table-column>
        <el-table-column prop="A" label="实际销售额" width="100" align="center"></el-table-column>
        <el-table-column prop="E" label="实际佣金" width="100" align="center"></el-table-column>
  ...
  methods: {
    ...
    doTest() {//计算销售额
      ...
      _this.tableData.forEach((item, index) => {
        ...
        _this.classState[index] = item["state"] ? "success-row" : "error-row";
      });
      this.$message({
        message: "测试成功",
        type: "success",
